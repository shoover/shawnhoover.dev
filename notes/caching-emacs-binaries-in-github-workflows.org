...
system[fn:1]. I'll probably write about the details eventually. For the purposes
of this post, my main requirements were:
...
The challenge was to get that down to a budget of 5 seconds, leaving plenty of time in a minute for runners to boot, build the site, and sync to S3.
